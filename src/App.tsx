...
import { ArrowUpRight, BookOpen, Check, ChevronRight, FileText, FileVideo, FolderOpen, Leaf, Link2, LoaderCircle, PanelLeftClose, PanelLeftOpen, Plus, Search, Settings2, Sparkles, Sprout, X } from 'lucide-react';
